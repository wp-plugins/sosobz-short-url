<div style="margin-top:2em;">
	...
	<p><a target="_blank" href="http://www.addthis.com/bookmark.php?url=<?php echo get_post_meta($post->ID, 'SosoBzShortURL', true); ?>"><img src="http://s7.addthis.com/static/btn/v2/lg-share-en.gif"></a></p>
</div>